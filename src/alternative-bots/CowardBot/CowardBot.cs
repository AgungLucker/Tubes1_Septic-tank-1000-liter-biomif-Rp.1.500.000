...
public class CowardBot : Bot
{
    ...
    CowardBot() : base(BotInfo.FromFile("CowardBot.json")) { }
    ...
    private void FindSafestDirection()
    {
        ...
        double safeX = Math.Max(150, Math.Min(width - 150, this.X + vectorX));
        double safeY = Math.Max(150, Math.Min(height - 150, this.Y + vectorY));
    ...
    public void Fire2(ScannedBotEvent e)
    {
        double enemyX = e.X;
        double enemyY = e.Y;
